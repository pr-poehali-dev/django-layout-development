        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">Выберите направление для развития</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div 
                className="bg-card border border-border rounded-2xl p-8 hover:shadow-xl transition-all cursor-pointer group"
                onClick={() => navigate('/acting')}
              >
                <div className="mb-6 w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Icon name="Clapperboard" size={32} className="text-primary" />
                </div>
                <h3 className="text-2xl font-bold mb-4">Актёрское мастерство</h3>
                <p className="text-muted-foreground mb-6">
                  Раскройте свой талант, научитесь играть на камеру и преодолейте страх сцены. 
                  Работа с профессиональным режиссёром, съёмка короткометражного фильма.
                </p>
                <ul className="space-y-2 mb-6">
                  ...
                  <li className="flex items-start gap-2">
                    <Icon name="Check" size={20} className="text-primary mt-1 flex-shrink-0" />
                    <span>Съёмка фильма</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="Check" size={20} className="text-primary mt-1 flex-shrink-0" />
                    <span>Актёрские техники</span>
                  </li>
                </ul>
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4">Ораторское искусство</h3>
                <p className="text-muted-foreground mb-6">
                  Научитесь уверенно выступать публично, убеждать и вдохновлять аудиторию. 
                  Развитие харизмы, дикции и навыков убеждающей речи.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start gap-2">
                    <Icon name="Check" size={20} className="text-primary mt-1 flex-shrink-0" />
                    <span>Техники речи</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon name="Check" size={20} className="text-primary mt-1 flex-shrink-0" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center bg-primary/5 rounded-2xl p-12 border border-primary/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="text-lg px-8 py-6" onClick={() => navigate('/contacts')}>
