  ...
  const achievements = [
    {
      ...
      description: 'Теленовелла «Обручальное кольцо» — победитель премии ТЕФИ-2012 в номинации «Телевизионный художественный сериал – телероман»'
    },
    {
      icon: 'Film',
      title: 'Фильмография',
      description: '«След», «Дело врачей», «До суда», «Маруся», «Наши соседи», «Обручальное кольцо», «Принцесса цирка»'
    },
    {
      icon: 'GraduationCap',
      title: 'Образование',
      description: 'ГИТИС (Режиссура драмы, с отличием), ВГИК (Высшие режиссерские курсы), курс АМЕДИА'
    },
    {
      icon: 'Star',
      title: 'Художественный руководитель',
      description: 'Художественный руководитель центра подготовки актеров кино. Практикующий режиссёр.'
    }
  ];
