  ...
  const achievements = [
    {
      ...
      description: 'Победитель национальной телевизионной премии в номинации "Лучший режиссёр телесериала"'
    },
    {
      icon: 'Film',
      title: '15+ сериалов',
      description: 'Режиссёр-постановщик более 15 телевизионных проектов на федеральных каналах'
    },
    {
      icon: 'Users',
      title: '500+ учеников',
      description: 'Более 500 выпускников курсов актёрского мастерства за 10 лет преподавания'
    },
    {
      icon: 'Star',
      title: 'Практикующий режиссёр',
      description: 'Действующий режиссёр кино и театра, продолжает снимать и ставить спектакли'
    }
  ];
  ...
  const experience = [
    {
      year: '2012',
      title: 'Премия ТЕФИ',
      description: 'Победитель национальной телевизионной премии ТЕФИ за режиссуру телесериала'
    },
    {
      year: '2010-2022',
      title: 'Режиссёр федеральных телеканалов',
      description: 'Работа над сериалами для Первого канала, НТВ, ТНТ. Более 1000 часов эфирного времени'
    },
    {
      year: '2015',
      title: 'Основание школы актёрского мастерства',
      description: 'Создание авторской методики обучения актёров для кино и театра'
    },
    {
      year: '2018',
      title: 'Театральный режиссёр',
      description: 'Постановка спектаклей в московских театрах. Работа с известными актёрами'
    },
    {
      year: '2020-н.в.',
      title: 'Педагог актёрского мастерства',
      description: 'Ведущий преподаватель курсов актёрского мастерства. Подготовка актёров для кино'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Казбек Меретуков - режиссёр-постановщик федеральных телесериалов, победитель премии ТЕФИ-2012, преподаватель актёрского мастерства. Опыт работы 15+ лет, более 500 учеников." />
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <section className="pt-20 pb-12 px-4 md:pt-32 md:pb-20">
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-6">
                  Режиссёр-постановщик федеральных телесериалов
                </p>
                <p className="text-lg mb-4">
                  🏆 Победитель премии ТЕФИ-2012
                </p>
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Более 15 лет опыта в кино и театре. Автор уникальной методики обучения актёрскому мастерству, 
                  основанной на реальном опыте съёмок федеральных телесериалов. 
                  Более 500 выпускников, многие из которых работают в кино и театре.
                </p>
              </div>
            ...
            <div className="mb-16">
              <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">Профессиональный путь</h2>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Режиссёр федеральных телесериалов, победитель премии ТЕФИ-2012, преподаватель актёрского мастерства с опытом более 15 лет",
          "award": "Премия ТЕФИ-2012 - Лучший режиссёр телесериала",
          "alumniOf": "Российский институт театрального искусства (ГИТИС)",
          "knowsAbout": ["Актёрское мастерство", "Режиссура", "Кинопроизводство", "Постановка сериалов", "Обучение актёров"],
