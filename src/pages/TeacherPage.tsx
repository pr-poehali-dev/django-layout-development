...
export default function TeacherPage() {
  ...
  const achievements = [
    ...
    },
    {
      icon: 'Film',
      title: '15+ сериалов',
      description: 'Режиссёр-постановщик более 15 телевизионных проектов на федеральных каналах за 25+ лет карьеры'
    },
    {
      icon: 'Users',
      title: '500+ учеников',
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed whitespace-pre-line">
                  {`Режиссёр-постановщик с опытом более 25 лет, обладатель премии ТЕФИ-2012 за лучшую режиссуру телесериала «Закрытая школа».
